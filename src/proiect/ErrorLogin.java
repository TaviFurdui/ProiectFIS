...
public class ErrorLogin extends Dialog {

	protected Object result;
	protected Shell shlEroareLogin;

	public ErrorLogin(Shell parent, int style) {
		super(parent, style);
		setText("SWT Dialog");
	}
	...
	private void createContents() {
		...
		shlEroareLogin.setText("Eroare login");
		...
		lblEroareLogin.setText("Ai introdus emailul sau parola gresita!");
